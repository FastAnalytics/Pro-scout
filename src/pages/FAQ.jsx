...
const QA = [
  { q: "What is Game Explorer?", a: "Game Explorer is the internal opportunity tool for Roblox Game Explorer — a Roblox studio that buys, revives and expands promising games. Scouts use this tool to surface titles with unusually high current CCU relative to their total lifetime visits, so we can move fast on acquisitions." },
  ...
  { q: "Why is the price always NaN?", a: "Game Explorer is a discovery tool, not a marketplace. If a seller has already listed a game on another platform, the asking price appears here automatically. Otherwise the panel shows NaN so scouts know to reach out fresh." },
  ...
  { q: "What does the AI Proposal do?", a: "It drafts an outreach message to the game’s creator on your behalf, introducing yourself as a scout from Roblox Game Explorer, asking for stats, and inviting them to a group chat. One click, ready to copy." },
  ...
  { q: "Does Game Explorer scrape Roblox?", a: "No. All data comes from Roblox’s public Games API via a lightweight proxy for rate-limit fairness. We never scrape HTML pages or bypass authentication." },
  { q: "Who built this?", a: "Built by DGRW2812 for the Roblox Game Explorer scout team. Massive thanks to Teddy and Hud for the constant feedback, testing, and late-night bug reports. Thanks for working at Roblox Game Explorer." },
];
    ...
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Everything you probably wanted to know about Game Explorer.</p>
        </div>
      </div>
      ...
      <div className="mt-10 rounded-xl border border-slate-800 bg-black p-6 text-center">
        ...
        <div className="text-white font-semibold">Thanks for working at Roblox Game Explorer</div>
        ...
        <div className="text-slate-500 text-xs mt-3">Good hunting. — Roblox Game Explorer Scout Team</div>
      </div>
    </main>
  );
}
